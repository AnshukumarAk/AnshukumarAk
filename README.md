...
const anshu = {
    ...
    location: "Noida Sector 59, India",
    education: "BCA @ William Carey University (2023-2026)",
    currentProject: "Meghdoot E Krishi",
...
- 📍 Based in **Noida Sector 59, India**
- 📫 Reach me at **kumaranshu07972@gmail.com**
- ⚡ Fun fact: I've built systems used across **India, Morocco & Jamaica**
...
|:-:|---------|-------------|------|:----:|
| 🌊 | **IWSMS** | Water Supply Monitoring System with role-based access & real-time tracking | `PHP` `CI4` `MySQL` `REST API` | [Live](https://iwsms.org) |
| 📊 | **Development Metrics** | Project Management Tool for KPIs, milestones & dashboards | `PHP` `MySQL` `JavaScript` | [Live](https://developmentmetrics.in) |
| 🌾 | **E-Agrology 360** | Agricultural data platform with Form Builder, ETL & Dashboard | `PHP` `ETL` `Dashboard` | [Live](https://eagro360dev.indevconsultancy.in/) |
| 🌍 | **PMD** | Global Dashboard for India, Morocco & Jamaica via Google Sheets | `PHP` `Google Sheets API` | [Live](https://pmd.indevconsultancy.com) |
| 🤖 | **IRRI Chatbot** | WhatsApp bot for farmers - crop info, weather & best practices | `PHP` `Picky Assist API` | [Live](https://rcm-irri.indevconsultancy.in/) |
| 📱 | **BBC Media Action** | WhatsApp chatbot for old cloth collection & resale initiative | `PHP` `Picky Assist API` | - |
| 🌿 | **Meghdoot E Krishi** | Smart agriculture platform with AI, WebSocket & marketplace | `PHP` `Laravel` `WebSocket` `AI` | [Live](https://meghdoot.indevconsultancy.com/) |
